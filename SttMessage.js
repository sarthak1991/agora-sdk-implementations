...
export const Agora = $root.Agora = (() => {
    ...
    Agora.SpeechToText = (function() {
        ...
        SpeechToText.Text = (function() {
             ...
             * @property {number|Long|null} [textTs] Text textTs
             */
            ...
            /**
             * Text textTs.
             * @member {number|Long} textTs
             * @memberof Agora.SpeechToText.Text
             * @instance
             */
            Text.prototype.textTs = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
            ...
            Text.encode = function encode(message, writer) {
                ...
                if (message.words != null && message.words.length)
                    for (let i = 0; i < message.words.length; ++i)
                        $root.Agora.SpeechToText.Word.encode(message.words[i], writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
                ...
                if (message.trans != null && message.trans.length)
                    for (let i = 0; i < message.trans.length; ++i)
                        $root.Agora.SpeechToText.Translation.encode(message.trans[i], writer.uint32(/* id 14, wireType 2 =*/114).fork()).ldelim();
                ...
                if (message.textTs != null && Object.hasOwnProperty.call(message, "textTs"))
                    writer.uint32(/* id 16, wireType 0 =*/128).int64(message.textTs);
                return writer;
            };
            ...
            Text.decode = function decode(reader, length) {
                ...
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Agora.SpeechToText.Text();
                while (reader.pos < end) {
                    ...
                    case 14: {
                            if (!(message.trans && message.trans.length))
                                message.trans = [];
                            message.trans.push($root.Agora.SpeechToText.Translation.decode(reader, reader.uint32()));
                            break;
                        }
                    case 15: {
            ...
            Text.verify = function verify(message) {
                ...
                if (message.words != null && message.hasOwnProperty("words")) {
                    ...
                    for (let i = 0; i < message.words.length; ++i) {
                        let error = $root.Agora.SpeechToText.Word.verify(message.words[i]);
                        if (error)
                            return "words." + error;
                    }
                }
                ...
                if (message.trans != null && message.hasOwnProperty("trans")) {
                    ...
                    for (let i = 0; i < message.trans.length; ++i) {
                        let error = $root.Agora.SpeechToText.Translation.verify(message.trans[i]);
                        if (error)
                            return "trans." + error;
                    }
                }
                ...
                if (message.textTs != null && message.hasOwnProperty("textTs"))
                    if (!$util.isInteger(message.textTs) && !(message.textTs && $util.isInteger(message.textTs.low) && $util.isInteger(message.textTs.high)))
                        return "textTs: integer|Long expected";
                return null;
            };
            ...
            Text.fromObject = function fromObject(object) {
                if (object instanceof $root.Agora.SpeechToText.Text)
                    return object;
                let message = new $root.Agora.SpeechToText.Text();
                ...
                if (object.textTs != null)
                    if ($util.Long)
                        (message.textTs = $util.Long.fromValue(object.textTs)).unsigned = false;
                    else if (typeof object.textTs === "string")
                        message.textTs = parseInt(object.textTs, 10);
                    else if (typeof object.textTs === "number")
                        message.textTs = object.textTs;
                    else if (typeof object.textTs === "object")
                        message.textTs = new $util.LongBits(object.textTs.low >>> 0, object.textTs.high >>> 0).toNumber();
                return message;
            };
            ...
            Text.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    if ($util.Long) {
                        let long = new $util.Long(0, 0, false);
                        object.textTs = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.textTs = options.longs === String ? "0" : 0;
                }
                if (message.vendor != null && message.hasOwnProperty("vendor"))
                ...
                if (message.trans && message.trans.length) {
                    ...
                    for (let j = 0; j < message.trans.length; ++j)
                        object.trans[j] = $root.Agora.SpeechToText.Translation.toObject(message.trans[j], options);
                }
                if (message.culture != null && message.hasOwnProperty("culture"))
                    object.culture = message.culture;
                if (message.textTs != null && message.hasOwnProperty("textTs"))
                    if (typeof message.textTs === "number")
                        object.textTs = options.longs === String ? String(message.textTs) : message.textTs;
                    else
                        object.textTs = options.longs === String ? $util.Long.prototype.toString.call(message.textTs) : options.longs === Number ? new $util.LongBits(message.textTs.low >>> 0, message.textTs.high >>> 0).toNumber() : message.textTs;
                return object;
            };
        ...
        SpeechToText.Word = (function() {
            ...
            Word.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Agora.SpeechToText.Word();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            Word.fromObject = function fromObject(object) {
                if (object instanceof $root.Agora.SpeechToText.Word)
                    return object;
                let message = new $root.Agora.SpeechToText.Word();
                if (object.text != null)
        ...
        SpeechToText.Translation = (function() {
            ...
            Translation.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Agora.SpeechToText.Translation();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            Translation.fromObject = function fromObject(object) {
                if (object instanceof $root.Agora.SpeechToText.Translation)
                    return object;
                let message = new $root.Agora.SpeechToText.Translation();
                if (object.isFinal != null)
                    message.isFinal = Boolean(object.isFinal);
                if (object.lang != null)
